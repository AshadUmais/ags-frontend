...
const OrderManagement = () => {
  ...
  const filteredOrders = orders.filter((order) => {
    ...
    return matchesOrderId && matchesUserId && matchesStatus && matchesCreatedAt && matchesBookingDate;
  });
                  ...
                  return (
                    <React.Fragment key={order.ID}>
                      <tr className="hover:bg-gray-200">
                        <td className="px-4 py-4 text-center whitespace-nowrap">{order.ID}</td>
                        <td className="px-4 py-4 text-center whitespace-nowrap">{order.user_id}</td>
                        ...
                        <td className="px-4 py-4 text-center whitespace-nowrap font-semibold text-green-600">
                          ₹{order.total_amount}
                        </td>
                        <td className="px-4 py-4 text-center whitespace-nowrap">
                          {statusEditId === order.ID ? (
                            <select
                              ...
                              className="border px-2 py-1 rounded focus:outline-none focus:ring-2 focus:ring-primary"
                              disabled={loading}
                            >
                              {statusOptions.map((s) => (
                        ...
                        <td className="px-4 py-4 text-center whitespace-nowrap">
                          <div className="flex justify-center items-center space-x-2">
                            <button
                              className="px-3 py-1.5 rounded bg-blue-500 text-white hover:bg-blue-600 text-xs font-medium transition disabled:opacity-50"
                            ...
                            {statusEditId === order.ID ? (
                              <button
                                className="px-3 py-1.5 rounded bg-green-600 text-white hover:bg-green-700 text-xs font-medium transition disabled:opacity-50"
                              ...
                              <button
                                className="px-3 py-1.5 rounded bg-yellow-500 text-white hover:bg-yellow-600 text-xs font-medium transition disabled:opacity-50"
                        ...
                        <tr className="bg-gradient-to-r from-blue-50 to-purple-50">
                          <td colSpan={7} className="px-6 py-4">
                            <div className="bg-white rounded-lg p-4 shadow-inner">
                              <h4 className="text-lg font-semibold mb-3 text-gray-800">Ticket Summary</h4>
                              <div className="grid grid-cols-2 gap-4">
                                <div className="bg-blue-50 rounded-lg p-4 border-l-4 border-blue-500">
                                  <div className="text-sm text-gray-600 mb-1">Adult Tickets</div>
                                  <div className="text-3xl font-bold text-blue-600">{ticketSummary.adult}</div>
                                </div>
                                <div className="bg-green-50 rounded-lg p-4 border-l-4 border-green-500">
                                  <div className="text-sm text-gray-600 mb-1">Child Tickets</div>
                                  <div className="text-3xl font-bold text-green-600">{ticketSummary.child}</div>
                                </div>
                              </div>
                            </div>
                          </td>
